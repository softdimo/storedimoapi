    ...
    public function getConfigInicial()
    {
        try {
            return response()->json([
                ...
                'estados' => Estado::whereIn('id_estado', [1,2,13,14,15])->orderBy('estado')->get(['estado', 'id_estado']),
                'estados_suscripciones' => Estado::whereIn('id_estado', [1,2,10,11,12,13])->orderBy('estado')->get(['estado', 'id_estado']),
