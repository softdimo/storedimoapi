...
$router->group(['prefix' => 'api/auth'], function () use ($router) {
    ...
    // Rutas que requieren estar autenticado pero pertenecen al módulo de sesión
...
// =====================================================================
// RUTAS PÚBLICAS / PRE-LOGIN / WEBHOOKS
// =====================================================================
$router->group(['prefix' => 'api'], function () use ($router) {
    // Webhook Wompi
    $router->post('wompi/webhook', 'wompi\webhook\WompiWebhookController@procesarNotificacion');
...
$router->group(['prefix' => 'api', 'middleware' => 'auth'], function () use ($router) {
    ...
    /**
     * Rutas del Tenant / Operación General
    */
